...
//-----------------------------------------------------------------------------
  ...
  function computeAnthro()  {
     ...
     var rTricepSkinFold=0;
     var rBicepSkinFold=0;
     var rSuprailiac=0;
     var rSubscapula=0;
     var rSumOfSkinFolds=0;
     var sTricepSkinFold='';
     var sBicepSkinFold='';
     var sSuprailiac='';
     var sSubscapula='';
     ...
     var rMidArmCircum=0;
     var sMidArmCircum='';
     var rMidArmCircumA=0;
     var sMidArmCircumA='';   
     var rWaistHipRatio=0;
     var sWaistHipRatio='';
     var sWaistHipRatioCat='';
     var rWaistCircum=0;
     var sWaistCircum='';
     var rHipCircum=0;
     var sHipCircum='';
     ...
     if (isSignedFloat(sHeight1,1)){
       ...
       console.log('Height is not numeric');
       setFocus('scrHeight1');
     } 
     if (rHeight1 < 0) {
       console.log('Height can not be negative');
       setFocus('scrHeight1');   
     }
     ...
     if (isSignedFloat(sHeight2,1)){
       ...
       console.log('Inches is not numeric');
       setFocus('scrHeight2');
     }  
     if (rHeight2 < 0) {
       console.log('Inches can not be negative');
       setFocus('scrHeight2');   
     }   
     sHeightUnits=document.getElementById('scrHeightUnits').value;  
     if (sHeightUnits==='ft'){  
       if (rHeight2 > 11 || rHeight2 < 0){
         console.log('Invalid inches (0-12)');
         setFocus('scrHeight2');   
       }
       ...
       console.log('Height units not available/unknown');
       sHeight3          = '';
     ...
     if (isSignedFloat(sWeight1,1)){
       ...
       console.log('Weight is not numeric');
       setFocus('scrWeight1');
     } 
     if (rWeight1 < 0) {
       console.log('Weight can not be negative');
       setFocus('scrWeight1');  
     }  
     ...
     if (sWeightUnits==='kg'){  
       ...
       console.log('Weight units not available/unknown');
       sWeight2 = '';
     ...
     //BMI
     if (rHeightMetric>0) {
       rBMI = rWeightMetric / ((rHeightMetric / 100) * (rHeightMetric / 100));
     }
     if (rBMI>0) {
       sBMI=currencyFormatted(rBMI);
     } else {
       sBMI='';
     }
     document.getElementById('scrBMI').value    = sBMI;
     document.getElementById('scrBMI').innerHTML= sBMI;   
     //BMI Category   
     if (rBMI===0){
       sBMICategory='';
     } else if (rBMI>0 && rBMI<18.5) {
       sBMICategory='< 18.5 -- Underweight';
     } else if (rBMI>=18.5 && rBMI<=24.9) {
       sBMICategory='18.5 - 24.9 -- Normal';
     } else if (rBMI>=25 && rBMI<=29.9) {
       sBMICategory='25.0 - 29.9 -- Overweight';
     } else if (rBMI>=30 && rBMI<=34.9) {
       sBMICategory='30.0 - 34.9 -- Obese, Class I';
     } else if (rBMI>=35 && rBMI<=34.9) {
       sBMICategory='35.0 - 35.9 -- Obese, Class II';
     } else if (rBMI>=40) {
       sBMICategory='>=40 -- Extremely Obese, Class III';
     } else {
       sBMICategory='';
     }
     document.getElementById('scrBMICategory').value    = sBMICategory;
     document.getElementById('scrBMICategory').innerHTML= sBMICategory;      
     //Ideal body weight
     ...
     //Tricep skin fold
     sTricepSkinFold=document.getElementById('scrTricepSkinFold').value;
     sTricepSkinFold=stripWhitespace(sTricepSkinFold);
     if (isSignedFloat(sTricepSkinFold,1)){
       rTricepSkinFold=sTricepSkinFold * 1; //force to use as number	
     }else{
       console.log('Tricep Skin Fold is not numeric');
       setFocus('scrTricepSkinFold');
     } 
     if (rTricepSkinFold < 0) {
       console.log('Tricep Skin Fold can not be negative');
       setFocus('scrTricepSkinFold');
     }   
     //Bicep Skin Fold  
     sBicepSkinFold=document.getElementById('scrBicepSkinFold').value;
     sBicepSkinFold=stripWhitespace(sBicepSkinFold);
     if (isSignedFloat(sBicepSkinFold,1)){
       rBicepSkinFold=sBicepSkinFold * 1; //force to use as number	
     }else{
       console.log('Bicep Skin Fold is not numeric');
       setFocus('scrBicepSkinFold');
     } 
     if (rBicepSkinFold < 0) {
       console.log('Bicep Skin Fold can not be negative');
       setFocus('scrBicepSkinFold');  
     } 
     //Suprailiac
     sSuprailiac=document.getElementById('scrSuprailiac').value;
     sSuprailiac=stripWhitespace(sSuprailiac);
     if (isSignedFloat(sSuprailiac,1)){
       rSuprailiac=sSuprailiac * 1; //force to use as number	
     }else{
       console.log('Suprailiac is not numeric');
       setFocus('scrSuprailiac');
     } 
     if (rSuprailiac < 0) {
       console.log('Suprailiac can not be negative');
       setFocus('scrSuprailiac');
     } 
     //Subscapula
     sSubscapula=document.getElementById('scrSubscapula').value;
     sSubscapula=stripWhitespace(sSubscapula);
     if (isSignedFloat(sSubscapula,1)){
       rSubscapula=sSubscapula * 1; //force to use as number	
     }else{
       console.log('Subscapula is not numeric');
       setFocus('scrSubscapula');
     } 
     if (rSubscapula < 0) {
       console.log('Subscapula can not be negative');
       setFocus('scrSubscapula');
     }   
     //Sum of Skinfolds
     rSumOfSkinFolds=(rTricepSkinFold*1)+(rBicepSkinFold*1)+(rSuprailiac*1)+(rSubscapula*1);
     if (rSumOfSkinFolds>0) {
       sSumOfSkinFolds=rSumOfSkinFolds+' mm';
     } else {
       sSumOfSkinFolds='';
     }
     document.getElementById('scrSumOfSkinfolds').innerHTML=sSumOfSkinFolds;
     //mid-arm circumference 
     sMidArmCircum=document.getElementById('scrMidArmCircum').value;
     sMidArmCircum=stripWhitespace(sMidArmCircum);
     if (isSignedFloat(sMidArmCircum,1)){
       rMidArmCircum=sMidArmCircum * 1; //force to use as number	
     }else{
       console.log('Mid-Arm Circumference is not numeric');
       setFocus('scrMidArmCircum');
     } 
     if (rMidArmCircum < 0) {
       console.log('Mid-Arm Circumference can not be negative');
       setFocus('scrMidArmCircum');  
     }      
     //mid-arm circumference A
     rMidArmCircumA=rMidArmCircum * rTricepSkinFold * 0.34;
     if (rMidArmCircumA>0) {
       sMidArmCircumA=currencyFormatted(rMidArmCircumA);
     } else {
       sMidArmCircumA='';
     }
     document.getElementById('scrMidArmCircumA').innerHTML=sMidArmCircumA;
     //waist circumference 
     sWaistCircum=document.getElementById('scrWaistCircum').value;
     sWaistCircum=stripWhitespace(sWaistCircum);
     if (isSignedFloat(sWaistCircum,1)){
       rWaistCircum=sWaistCircum * 1; //force to use as number	
     }else{
       console.log('Waist Circumference is not numeric');
       setFocus('scrWaistCircum');
     } 
     if (rWaistCircum < 0) {
       console.log('Waist Circumference can not be negative');
       setFocus('scrWaistCircum');  
     } 
     //hip circumference 
     sHipCircum=document.getElementById('scrHipCircum').value;
     sHipCircum=stripWhitespace(sHipCircum);
     if (isSignedFloat(sHipCircum,1)){
       rHipCircum=sHipCircum * 1; //force to use as number	
     }else{
       console.log('Hip Circumference is not numeric');
       setFocus('scrHipCircum');
     } 
     if (rHipCircum < 0) {
       console.log('Hip Circumference can not be negative');
       setFocus('scrHipCircum');
     }  
     //Waist to Hip Ratio
     if (rHipCircum>0) {
       rWaistHipRatio = rWaistCircum / rHipCircum;
       if (rWaistHipRatio>0) {
         sWaistHipRatio = currencyFormatted(rWaistHipRatio);
         if (rWaistHipRatio >0.80 && sSex==='Female') {
           sWaistHipRatioCat = '>.80 at risk women';
         }
         if (rWaistHipRatio >0.90 && sSex==='Male') {
           sWaistHipRatioCat = '>.90 at risk men';
         }
       } else {
         sWaistHipRatio='';
         sWaistHipRatioCat='';
     ...
     document.getElementById('scrWaistHipRatio').innerHTML=sWaistHipRatio;
     document.getElementById('scrWaistHipRatioCat').innerHTML=sWaistHipRatioCat;
     //age 
     ...
     if (isSignedFloat(sAge,1)){
       ...
       rAge=0;
       console.log('Age is not numeric');
       setFocus('scrAge');
     } 
     if (rAge < 0) {
     ...
     //    male: ((10*weight in kg) + (6.25 * height in cm) - (5 * age) + 5) * ais factor
     //  female: ((10*weight in kg) + (6.25 * height in cm) - (5 * age) - 161) * ais factor
  
     rAISFactor=document.getElementById('scrAIS').value;
     rAISFactor=rAISFactor * 1;
     if ((rAISFactor===0) || (sSex==='') || (rWeightMetric===0) || (rHeightMetric===0) || (rAge===0)) {
        sMifflinStJeor='';
     } else {
       if (sSex==='Male'){
         rMifflinStJeor = ((10 * rWeightMetric) + (6.25 * rHeightMetric) - (5 * rAge) + 5) * rAISFactor;
       }
       if (sSex==='Female'){
         rMifflinStJeor = ((10 * rWeightMetric) + (6.25 * rHeightMetric) - (5 * rAge) - 161) * rAISFactor;
       }
       if (rMifflinStJeor > 0){
         sMifflinStJeor = currencyFormatted(rMifflinStJeor);
       } else {
         sMifflinStJeor = '';
       }
     }   
     //document.getElementById('scrMifflinStJoer').innerHTML=sMifflinStJeor;
  }
  ...
  function clearScr()  {
    ...
    //document.getElementById('scrWeight2').value     = '';
    document.getElementById('scrWeight2').innerHTML= '';
    //document.getElementById('scrBMI').value         = '';
    document.getElementById('scrBMI').innerHTML     = '';
    //document.getElementById('scrBMICategory').value = '';
    document.getElementById('scrBMICategory').innerHTML = '';
    document.getElementById('scrSex').value         = ' ';
    //document.getElementById('scrIdealBodyWt').value = '';
    document.getElementById('scrIdealBodyWt').innerHTML = '';
    //document.getElementById('scrPercentIdealBodyWt').value = '';
    document.getElementById('scrPercentIdealBodyWt').innerHTML = '';
    document.getElementById('scrTricepSkinFold').value = '';
    document.getElementById('scrBicepSkinFold').value  = '';
    document.getElementById('scrSuprailiac').value     = '';
    document.getElementById('scrSubscapula').value     = '';
    document.getElementById('scrSumOfSkinfolds').innerHTML = '';
    document.getElementById('scrMidArmCircum').value   = '';
    document.getElementById('scrMidArmCircumA').innerHTML = '';
    document.getElementById('scrWaistCircum').value    = '';
    document.getElementById('scrHipCircum').value      = '';
    document.getElementById('scrWaistHipRatio').innerHTML = '';
    document.getElementById('scrWaistHipRatioCat').innerHTML = '';    
    ...
    document.getElementById('scrMifflinStJoer').innerHTML  = '';  
    //document.getElementById('scrNotes').innerHTML  = ''; 
...
//     console.log("Text exceeds max size of "+obj.id+" characters and spaces. \nText truncated.")
//   }
// }
...
//     //console.log("Text exceeds max size of "+ maxLimit +" characters and spaces. \nText truncated.")
...
//     } else {
//       console.log("Time is not valid. Use format hh:mm")
//       Obj.focus()
//     }
//   } else {
//     console.log("Time is not valid.")
...
//     datefield.select();
//     console.log("That date is invalid.  Please try again.");
//     datefield.focus();
//     return false;
//   }else{
//     return true;
...
//       if (chkType=='NoFuture'){
//         if (nd>today) {
//           console.log("Date can not be in the future")
//           datefield.select();
//           datefield.focus();
//           return false;
//         }
...
//         if (nd>=today) {
//           console.log("Date must be before today")
//           datefield.select();
//           datefield.focus();
//           return false;
//         }
